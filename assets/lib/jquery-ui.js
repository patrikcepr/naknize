...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNamesShort: [ "Led", "Únr", "Břz", "Dub", "Kvt", "Čvn", "Čvc", "Srp", "Zář", "Řjn", "Lst", "Pnc" ], // For formatting
		dayNames: [ "Neděle", "Pondělí", "Úterý", "Středa", "Čtvrtek", "Pátek", "Sobota" ], // For formatting
		dayNamesShort: [ "Nďl", "Pnd", "Útr", "Stř", "Čtr", "Ptk", "Sbt" ], // For formatting
		dayNamesMin: [ "Ne","Po","Út","St","Čt","Pá","So" ], // Column headings for days starting at Sunday
		weekHeader: "Td", // Column header for week of the year
